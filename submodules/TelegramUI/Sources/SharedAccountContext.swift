...
public final class SharedAccountContextImpl: SharedAccountContext, DuressAccountSwitching {
    ...
    public var activeAccountContexts: Signal<(primary: AccountContext?, accounts: [(AccountRecordId, AccountContext, Int32)], currentAuth: UnauthorizedAccount?), NoError> {
        if DuressSwitchingRegistry.current !== self {
            DuressSwitchingRegistry.current = self
        }
    ...
    public func duressSwitchToAccount(id: Int64) {
        self.switchToAccount(id: AccountRecordId(rawValue: id))
    }
