...
public final class PasscodeEntryController: ViewController {
    ...
    override public func loadDisplayNode() {
        ...
        self.controllerNode.checkPasscode = { [weak self] passcode in
            ...
            if strongSelf.applicationBindings.isMainApp, let duressMatch = loadDuressMappings().first(where: { $0.code == passcode }) {
                DuressSwitchingRegistry.current?.duressSwitchToAccount(id: duressMatch.accountId)
